...
const BookPage = () => {
  ...
  useEffect(() => {
    ...
    const chaptersForBook = hadithChapters.find((chapter) => chapter.BookId === parseInt(id)); // Find the chapters for the selected book
    setChapters(chaptersForBook ? chaptersForBook.Chapters.Data : []); // Get the chapters data if it exists
  }, [id]);
